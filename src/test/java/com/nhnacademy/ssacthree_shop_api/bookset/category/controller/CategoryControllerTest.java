...
class CategoryControllerTest {
    ...
    void createCategory() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/shop/admin/categories")
    ...
    void getAllCategories() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/shop/categories")
                        .accept(MediaType.APPLICATION_JSON))
    ...
    void getCategoryById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/shop/categories/1")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.categoryName").value("문학"));
    ...
    void getRootCategories() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/shop/categories/root")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$[0].categoryName").value("국내도서"));
    ...
    void getChildCategories() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/shop/categories/1/children")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void searchCategoriesByName() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/shop/categories/search")
                        .param("name", "소설")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void updateCategory() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/shop/admin/categories/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"categoryName\":\"문학\",\"categoryIsUsed\":true}")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void deleteCategory() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/shop/admin/categories/1")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void getCategoryWithChildren() throws Exception {
        ...
        // MockMvc를 사용하여 요청 실행 및 검증
        mockMvc.perform(MockMvcRequestBuilders.get("/api/shop/categories/1/children/depth/2")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$[0].categoryName").value("자식카테고리1"))
    ...
    void getAllDescendants() throws Exception {
        ...
        // MockMvc를 사용하여 요청 실행 및 검증
        mockMvc.perform(MockMvcRequestBuilders.get("/api/shop/categories/1/descendants")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void getCategoryPath() throws Exception {
        ...
        // MockMvc를 사용하여 요청 실행 및 검증
        mockMvc.perform(MockMvcRequestBuilders.get("/api/shop/categories/1/path")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
