...
public class MemberController {
    ...
    public ResponseEntity<Page<BookListResponse>> getBooksByMemberId(
        ...
        Page<BookListResponse> books = bookCommonService.getBooksByMemberId(pageable,
            memberService.getCustomerIdByMemberLoginId(memberId));
     ...
     */
    @GetMapping("/likeList")
    public ResponseEntity<List<Long>> getLikedBooksIdForCurrentUser(
        @RequestHeader(name = "X-USER-ID") String memberId) {
        List<Long> bookIdList = bookCommonService.getLikedBooksIdForCurrentUser(
            memberService.getCustomerIdByMemberLoginId(memberId));
     ...
     */
    @PostMapping("/likes")
    public ResponseEntity<BookLikeResponse> createBookLikeByMemberId(
    ...
    public ResponseEntity<Boolean> deleteBookLikeByMemberId(
        @PathVariable(name = "book-id") Long bookId,
        @RequestHeader(name = "X-USER-ID") String memberId) {
        Boolean result = bookCommonService.deleteBookLike(bookId,
            memberService.getCustomerIdByMemberLoginId(memberId));
